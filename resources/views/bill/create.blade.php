                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 mt-2">
                            <input type="date" required name="tgl_pembayaran" class="form-control" value={{$data[0]->tgl_pengiriman}}>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="table-responsive text-center">
                        ...
                        <?php $i=0; ?>
                            ...
                            <tr>
                                ...
                                <td hidden> <input type="text" value={{ $d->id_pengiriman }} name="id_pengiriman[]"></td>
