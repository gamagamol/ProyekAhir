        ...
        <div class="card shadow mb-4 ml-4 mr-4">
            ...
            <div class="container mt-2">
                <div id="table_atas">
                    ...
                    <div class="table-responsive text-center mt-2">
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            @foreach ($data as $p)
                                ...
                                <?php $berat += $p->berat_detail_pembelian; ?>
                                <?php $jumlah += $p->jumlah_detail_pembelian; ?>
                                <?php $ppn += $p->ppn_detail_pembelian; ?>
                                <?php $subtotal += $p->subtotal_detail_pembelian; ?>
                                <?php $total += $p->total_detail_pembelian; ?>
                    ...
                    <a href="{{ url('paymentvendor') }}" class="btn btn-primary  mb-4 ml-3"
